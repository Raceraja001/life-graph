...
class EvalRun(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "trigger IN ('manual','nightly_cron','optimization_test','regression_check')",
